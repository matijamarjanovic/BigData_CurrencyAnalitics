...
public class ProducerEURtoRSD {
    ...
    public static void main(String[] args) {
        ...
        String url = "https://www.alphavantage.co/query?function=FX_WEEKLY&from_symbol=EUR&to_symbol=RSD&apikey=YZ728BGP7767IBG6";
        //String url = "https://www.alphavantage.co/query?function=FX_WEEKLY&from_symbol=RSD&to_symbol=EUR&apikey=YZ728BGP7767IBG6";
        ...
        for (Map.Entry<String, Week.WeeklyRate> entry : timeSeries.entrySet()) {
            ...
            String key = date;
            String value = "EUR to RSD\t"  + forexData.toString();
